...
<h2 class="h2" >POSEZ VOS QUESTIONS!</h2>
    ...
    <div class="row">
          <div class="col-25">
            ...
            <label for="name"  ><strong>Nom et Prénom :</strong><br></label>
            </div>
            <div class="col-75">
        ...
        <div class="row">
              <div class="col-25">
                      <br><label for="message" ><strong>Message :</strong></label>
              </div>
              <div class="col-75">
                      <textarea  id ="message" placeholder="Tapez votre question!"   name="message" ></textarea>
              </div>
              </div>
        ...
        <button class="bot" type="button" onclick="sendEmail()" value="Send ">Submit</button> 
                ...
                $.ajax({
                   ...
                   data: {
                       ...
                       message: message.val(),
                        ...
                        $('#myForm')[0].reset();
                        $('.sent-notification').text("Nous avons bien reçu votre message!");
                   }
                });
            }
        }
